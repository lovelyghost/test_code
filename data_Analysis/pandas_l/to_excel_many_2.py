...
for i in file_url:
    if i.endswith("csv"):
        data_all = read_csv('/Users/lx/Desktop/bills_bills/'+ i, encoding='GB18030',na_filter=False)
        print(data_all)
        # data_all.iat[-1,5] = '\t' + data_all[u'商户号'][0]
        # data_all.iat[-1,6] = str(data_all[u'交易时间'][0])[:10]

        data_detail = data_all[0:-2]
        # data_detail[u'交易时间'] ='\t' + data_detail[u'交易时间']
        # data_detail[u'APPID'] ='\t' + data_detail[u'APPID']
        # data_detail[u'商户号'] ='\t' + data_detail[u'商户号']
        # data_detail[u'子商户号'] ='\t' + data_detail[u'子商户号']
        # data_detail[u'Uline订单号'] ='\t' + data_detail[u'Uline订单号']
        # data_detail[u'第三方订单号'] ='\t' + data_detail[u'第三方订单号']
        # data_detail[u'商户订单号'] = '\t' +data_detail[u'商户订单号']
        ...
        data_statistics.to_csv('/Users/lx/test_code/data_Analysis/pandas_l/交易汇总.csv',mode='a',
                               index=False,encoding='GB18030',header=False,columns=[u'交易时间', u'APPID', u'商户号',u'子商户号',u'设备编号',u'Uline订单号',
             u'第三方订单号',u'商户订单号'])
